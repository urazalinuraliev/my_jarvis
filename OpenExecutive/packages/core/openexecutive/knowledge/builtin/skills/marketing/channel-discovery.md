...
description: Identify and score acquisition channels by audience fit, speed, cost,
  effort, and learning value, then recommend the top three.
when_to_use: When choosing where to reach a defined audience, planning go-to-market,
  or replacing an underperforming channel.
category: marketing
---

# Channel Discovery

> **Requirements:** Requires internet access for channel research and competitor presence checks.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/channel-discovery/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
