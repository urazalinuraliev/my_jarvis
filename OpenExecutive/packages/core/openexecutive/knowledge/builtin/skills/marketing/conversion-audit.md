...
description: Run a scored 53-point conversion audit covering customer focus, narrative,
  copy, design, calls to action, and proof.
when_to_use: When a landing, sales, product, or ad destination page needs diagnosis,
  pre-launch review, or prioritized conversion fixes.
category: marketing
---

# Conversion Audit

> **Requirements:** Requires internet access to fetch URLs.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/conversion/conversion-audit/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
