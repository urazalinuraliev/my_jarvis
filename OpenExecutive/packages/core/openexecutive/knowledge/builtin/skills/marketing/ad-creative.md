---
name: ad-creative
description: Turn ad concepts into HTML creative in cookie-cutter, ugly, meme, branded,
  or native styles, with optional Playwright screenshots.
when_to_use: When producing, varying, or iterating visual ad assets for testing.
category: marketing
---

# Ad Creative

> **Requirements:** Optional: Playwright MCP for screenshot capture. Degrades to HTML-only without it.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/ads/ad-creative/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
