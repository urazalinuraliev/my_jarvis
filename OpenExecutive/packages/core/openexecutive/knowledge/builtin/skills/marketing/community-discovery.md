...
description: Discover and score online communities across Reddit, Slack, Discord,
  Facebook, LinkedIn, and independent forums.
when_to_use: When finding where a target audience gathers, planning organic participation,
  partnerships, or community-led go-to-market.
category: marketing
---

# Community Discovery

> **Requirements:** Requires internet access for web search and community directory lookups.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/community-discovery/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
