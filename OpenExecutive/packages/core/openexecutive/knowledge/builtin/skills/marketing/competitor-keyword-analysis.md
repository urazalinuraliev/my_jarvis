...
description: Map a competitor's organic search footprint with Keywords Everywhere
  ranking keywords, traffic estimates, and content-theme clusters.
when_to_use: When comparing SEO visibility, identifying competitor keyword strengths,
  or preparing deeper content-gap analysis.
category: marketing
---

# Competitor Keyword Analysis

> **Requirements:** Requires Keywords Everywhere MCP. Returns empty data gracefully if not connected.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/competitor-keyword-analysis/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
