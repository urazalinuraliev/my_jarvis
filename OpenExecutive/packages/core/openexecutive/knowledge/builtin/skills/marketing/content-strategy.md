...
description: Create or refresh a content strategy with pillars, topic clusters, buyer-stage
  keyword mapping, priorities, and an editorial calendar.
when_to_use: When planning what a company should publish and why, before drafting
  individual pieces.
category: marketing
---
...
> **Requirements:** Requires internet access for competitor and forum research. Optional: keyword data from external tools.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/content/content-strategy/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
