---
name: ad-angles
description: Brainstorm ad concepts across problem, solution, comparison, proof, and
  curiosity angles, formats, and visual styles.
when_to_use: When planning a campaign, refreshing stale creative, testing messaging,
  or preparing creative briefs.
category: marketing
---
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/ads/ad-angles/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
