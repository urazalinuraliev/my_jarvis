...
description: Run a scored 38-point audit of a URL covering SEO fundamentals, content
  structure, AI-search/GEO readiness, and E-E-A-T signals.
when_to_use: When auditing a page, diagnosing search visibility, reviewing content
  before publication, or prioritizing SEO and AI-search fixes.
category: marketing
---

# Search Audit

> **Requirements:** Requires internet access to fetch URLs, robots.txt, sitemap.xml, and llms.txt
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/search/search-page-audit/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
