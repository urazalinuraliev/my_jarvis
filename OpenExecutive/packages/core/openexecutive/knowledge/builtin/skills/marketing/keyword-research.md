...
description: Expand seed topics with Keywords Everywhere, retrieve live metrics, cluster
  terms by search intent, and score priorities.
when_to_use: When building a keyword universe, planning SEO content, validating demand,
  or finding search gaps.
category: marketing
---
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/keyword-research/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
