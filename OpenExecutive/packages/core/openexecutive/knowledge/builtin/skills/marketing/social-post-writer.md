...
description: Write platform-adapted social posts from a topic using story, observation,
  contrarian, listicle, past-versus-present, hand-raiser, launch, meme, and carousel
  templates.
when_to_use: When drafting new social posts without a long-form source to repurpose.
category: marketing
---
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/content/social-post-writer/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
