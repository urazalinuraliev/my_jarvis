...
description: Discover and score relevant influencers across YouTube, X, blogs, newsletters,
  podcasts, and Instagram.
when_to_use: When building a sponsorship, affiliate, co-marketing, outreach, PR, or
  audience-research list for a defined market.
category: marketing
---

# Influencer Discovery

> **Requirements:** Requires internet access for web search and profile lookups.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/influencer-discovery/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
