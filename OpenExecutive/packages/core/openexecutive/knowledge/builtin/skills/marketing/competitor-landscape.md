...
description: Synthesize research on two or more competitors into feature and pricing
  comparisons, positioning, SWOT, moat analysis, and strategic recommendations.
when_to_use: After individual competitor profiles exist or when preparing a market
  landscape.
category: marketing
---
...
> **Requirements:** Best results when provided with detailed competitor data from prior analysis.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/competitor-landscape/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
