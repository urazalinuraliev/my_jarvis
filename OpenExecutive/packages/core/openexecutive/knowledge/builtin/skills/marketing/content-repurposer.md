...
description: Turn a blog post, newsletter, podcast, video transcript, or other long-form
  source into a week of short-form social content using the Hub & Spoke method.
when_to_use: When repurposing an existing source rather than writing from a topic
  alone.
category: marketing
---
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/content/content-repurposer/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
