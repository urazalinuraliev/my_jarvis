...
description: Grade running ads as Red (stop), Yellow (hold), or Green (scale), detect
  creative fatigue, analyze LTV:CAC, and recommend scaling actions.
when_to_use: When reviewing campaign exports or deciding what to kill, keep, or scale.
category: marketing
---

# Ad Campaign Analyzer

> **Requirements:** Accepts campaign data as CSV, table, or pasted text.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/ads/ad-campaign-analyzer/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
