...
description: Inspect a competitor website and extract structured evidence about the
  company, positioning, pricing, social proof, and hiring signals.
when_to_use: When creating a current competitor profile from public pages before comparative
  analysis.
category: marketing
---
...
> **Requirements:** Requires internet access. Optional: Playwright MCP for JS-rendered pages.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/competitor-site-analysis/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
