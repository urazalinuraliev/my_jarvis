...
description: Find, verify, classify, and rank direct, adjacent, and tangential competitors
  from public web evidence.
when_to_use: When entering a market, building a competitor set, validating perceived
  alternatives, or refreshing research after a pivot.
category: marketing
---

# Competitor Discovery

> **Requirements:** Requires internet access for web search and competitor website fetching.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/competitor-discovery/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
