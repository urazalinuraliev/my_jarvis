...
description: Analyze what a competitor publishes, which content earns estimated traffic,
  the SEO plays they use, and where gaps exist.
when_to_use: Before creating or refreshing a content strategy or when investigating
  a competitor's organic content performance.
category: marketing
---

# Competitor Content Analysis

> **Requirements:** Requires internet access. Optional: Keywords Everywhere MCP for traffic metrics, Playwright MCP for JS-rendered pages.
...
*Imported from [ai-marketing-skills](https://github.com/superamped/ai-marketing-skills) — `skills/research/competitor-content-analysis/SKILL.md`. Copyright © 2026 SUPERAMPED LTD, MIT License; full text in `LICENSE-ai-marketing-skills.txt`. Generated by `scripts/import_marketing_skills.py`: edit the pack and re-run it instead of editing this file.*
